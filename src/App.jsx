    ...
    <div className="app">
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', gap: '30px', alignItems: 'center' }}>
          <a href="#about" style={{ color: 'rgba(165, 42, 42, 1)', textDecoration: 'none' }}>About Us</a>
          <a href="#services" style={{ color: 'rgba(165, 42, 42, 1)', textDecoration: 'none' }}>Services</a>
          <a href="#properties" style={{ color: 'rgba(165, 42, 42, 1)', textDecoration: 'none' }}>Property Search</a>
          <a href="#map" style={{ color: 'rgba(165, 42, 42, 1)', textDecoration: 'none' }}>Map Search</a>
          <a href="#contact" style={{ color: 'rgba(165, 42, 42, 1)', textDecoration: 'none' }}>Contacts</a>
          <button style={{
            background: '#e67e22',
            color: 'white',
            border: 'none',
